...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Bob Vance", "bob@gmail.com", new DateTime(1998, 4, 21), 1800.00, d1);
            Seller s2 = new Seller(2, "Jailson Mendes", "jailson@gmail.com", new DateTime(1985, 7, 15), 3000.00, d2);
            Seller s3 = new Seller(3, "Sasha Brian", "sasha@gmail.com", new DateTime(1994, 3, 30), 1500.00, d3);
            Seller s4 = new Seller(4, "Donald McDonald", "donald@gmail.com", new DateTime(1964, 3, 22), 1800.00, d4);
            Seller s5 = new Seller(5, "Robert Lion", "robert@gmail.com", new DateTime(1989, 8, 30), 2500.00, d2);
            Seller s6 = new Seller(6, "Phyllis Vance ", "sasha@gmail.com", new DateTime(1951, 7, 10), 1800.00, d1);
